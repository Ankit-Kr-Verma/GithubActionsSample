...
SVC_NAME="actions.runner.Ankit-Kr-Verma-GithubActionsSample.self-hosted-runner-using-docker"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Ankit-Kr-Verma-GithubActionsSample.self-hosted-runner-using-docker)"
